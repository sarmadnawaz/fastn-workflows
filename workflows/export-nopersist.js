export default async function (ctx) {
  ...
  // =========================================================================
  let resume = null; // NON-PERSISTENT VARIANT (old model): never resume from checkpoint
  ...
  try {
    ...
    async function saveCheckpoint(pass, cursor) {
      // NON-PERSISTENT VARIANT: no checkpoint written (old model — disruption restarts from zero)
      try {
